...
public class HardwareTrippleClutchers {
    ...
    */
    public HardwareTrippleClutchers() {
    }
    ...
    public void init(HardwareMap ahwMap) {
        ...
        motorShoulder = hwMap.dcMotor.get("motorShoulder");//shoulder
        motorElbow = hwMap.dcMotor.get("motorElbow");//elbow
        //servo
        ...
        //Keep the mototorBackLeft = hwMap.dcMotor.get("motorBL");
        //        motorBackRrs from moving during initialize.
